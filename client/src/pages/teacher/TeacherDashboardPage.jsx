  ...
  return (
    <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
      <div style={{ 
        ...
        <div>
          <h1 style={{ margin: 0, color: '#333' }}>Proyecto Redes - Docente</h1>
          <p style={{ margin: '5px 0 0', color: '#666' }}>Panel del Docente</p>
        </div>
        <button
          onClick={logout}
          style={{
      ...
      <div style={{ marginBottom: '30px' }}>
        <h2 style={{ color: '#495057', marginBottom: '15px' }}>Panel del Docente</h2>
        <div style={{ 
          display: 'grid', 
      ...
      <div>
        <h2 style={{ color: '#495057', marginBottom: '15px' }}>Resumen de Clases</h2>
        {loading ? (
          ...
          <div style={{ display: 'grid', gap: '15px' }}>
            {classes.map((classItem) => (
              <div key={classItem.id} style={{ padding: '15px', border: '1px solid #e0e0e0', borderRadius: '8px', backgroundColor: 'white' }}>
